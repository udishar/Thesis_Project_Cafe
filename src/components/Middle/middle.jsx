    ...
    return(
        <div className={style.container}>
          ...
          <div className={style.midTop}>
           ...
           <div className={style.icon}> <BsLightningFill/></div>
          </div>
          ...
          <span className={style.miniText}>Our mission is to fill your tummy with delicious food and with free & fast delivery</span>

          <Button className={style.btn} text={buttonText()} onClick={()=>handleClick()} />
          </div>
        
          <div className={style.right}>
             
         <img src="https://www.freepnglogos.com/uploads/food-png/fast-food-transparent-png-pictures-icons-and-png-18.png" className={style.img}  alt = "" />
